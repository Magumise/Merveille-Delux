...
if(isset($_POST['post'])){
   ...
   if($image_01_size > 2000000){
      ...
      $insert_property->execute([null, $user_id, $property_name, $address, $price, $type, $offer, $status, $furnished, $bhk, $deposite, $bedroom, $bathroom, $balcony, $carpet, $age, $total_floors, $room_floor, $loan, $lift, $security_guard, $play_ground, $garden, $water_supply, $power_backup, $parking_area, $gym, $shopping_mall, $hospital, $school, $market_area, $rename_image_01, $rename_image_02, $rename_image_03, $rename_image_04, $rename_image_05, $description,$date]);
...
<section class="property-form">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <div class="box">
         <p>date <span>*</span></p>
         <input type="hidden" name="date" value="<?php echo date("y/m/d")?>" class="input">
      </div>
      <div class="flex">
         <div class="box">
