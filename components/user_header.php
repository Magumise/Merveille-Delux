...
<header class="header">
   ...
   <nav class="navbar nav-1">
      <section class="flex">
         <a href="index.php" class="logo"><i class="fas fa-house"></i>MERVE REAL ESTATE</a>
         ...
         <ul>
            ...
            <li><a href="#">account <i class="fas fa-angle-down"></i></a>
               <ul>
                  ...
                  <li><a href="components/user_logout.php" onclick="return confirm('Do you want to logout from this website?');">logout</a>
                  <?php } else{?>
