      ...
      <form action="" method="post">
         ...
         if(isset($_POST['send'])){
            ...
            if($verify_contact->rowCount() > 0){
               ...
               if ($send_message){
                  echo "<font size='3px' padding='5px' color='green' text-align='center'>Message sent succefully.</font>";
              }else{
                  echo "<font size='3px' padding='5px' color='red' text-align='center'>OOoops something went wrong, try again later.</font>";
              }
            }
...
<section class="faq" id="faq">
   ...
   <div class="box-container">
      ...
      <div class="box active">
         ...
         <p>Our experienced team is available 24/7 to assist you with all your real estate needs. Contact us for personalized service and expert advice.</p>
      </div>

      <div class="box active">
         <h3><span>when will I get the possession?</span><i class="fas fa-angle-down"></i></h3>
         <p>Looking for a specific property? Our dedicated agents will help you find exactly what you're looking for.</p>
      </div>
