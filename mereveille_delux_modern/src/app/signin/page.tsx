      ...
      <div className="bg-white rounded-lg shadow-lg flex w-full max-w-4xl overflow-hidden">
        <div className="w-full md:w-1/2 p-10 flex flex-col justify-center">
          <div className="mb-8 flex items-center">
            ...
            <span className="text-2xl font-bold text-blue-700">Sign in</span>
          </div>
          ...
          <div className="mt-6 text-center text-gray-600">
            New to Merveille Delux? <Link href="/signup" className="text-blue-600 font-semibold hover:underline">Create account</Link>
          </div>
        </div>
        <div className="hidden md:block w-1/2 bg-gray-100">
          <img src="/zillow-signin.jpg" alt="Sign in visual" className="object-cover w-full h-full" />
        </div>
      </div>
    </div>
  );
