...
<section class="view-property">
   ...
   <?php
      $select_properties = $conn->prepare("SELECT * FROM `property` WHERE id = ? ORDER BY id DESC LIMIT 1");
   ...
   <div class="details">
     <div class="swiper images-container">
      ...
      <div class="info">
         ...
         <p><i class="fas fa-phone"></i><a href="tel:+256744578890"><?= $fetch_user['number']; ?></a></p>
      ...
      <div class="flex">
         ...
         <div class="box">
            <p><i>carpet area :</i><span><?= $fetch_property['carpet']; ?> areas</span></p>
